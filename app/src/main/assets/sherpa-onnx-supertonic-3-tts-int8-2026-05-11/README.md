...
The large SuperTonic 3 model files are intentionally not committed to this
repository. Before building or running the Android app, download and extract the
model archive into this directory:

`app/src/main/assets/sherpa-onnx-supertonic-3-tts-int8-2026-05-11/`
...
Invoke-WebRequest -Uri https://github.com/k2-fsa/sherpa-onnx/releases/download/tts-models/sherpa-onnx-supertonic-3-tts-int8-2026-05-11.tar.bz2 -OutFile app\src\main\assets\sherpa-onnx-supertonic-3-tts-int8-2026-05-11.tar.bz2
tar -xjf app\src\main\assets\sherpa-onnx-supertonic-3-tts-int8-2026-05-11.tar.bz2 -C app\src\main\assets
Remove-Item app\src\main\assets\sherpa-onnx-supertonic-3-tts-int8-2026-05-11.tar.bz2
```

After extraction, this directory must contain:
